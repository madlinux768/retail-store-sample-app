#!/bin/bash
# ECS Lab 2 Rollback: Restore Carts Task Definition
set -e
...
BACKUP_FILE="$SCRIPT_DIR/ecs-carts-original-taskdef.txt"

echo "=== ECS Lab 2: Cart Memory Leak Rollback ==="
echo ""
...
echo "Carts service will recover within 2-3 minutes as the healthy task deploys."
